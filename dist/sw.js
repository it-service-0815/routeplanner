const CACHE='routenplaner-r5-5-1-20260727';
const ASSETS=['./','./index.html','./styles.css?v=16','./app.js?v=15','./core.js?v=15','./routing.js','./engelhard-logo.svg','./version.json','./manifest.webmanifest'];
