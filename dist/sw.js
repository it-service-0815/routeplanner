const CACHE='routenplaner-r5-4-2-20260727';
const ASSETS=['./','./index.html','./styles.css?v=13','./app.js?v=13','./core.js?v=13','./routing.js','./engelhard-logo.svg','./version.json','./manifest.webmanifest'];
