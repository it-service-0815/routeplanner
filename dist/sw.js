const CACHE='routenplaner-r5-4-3-20260727';
const ASSETS=['./','./index.html','./styles.css?v=14','./app.js?v=14','./core.js?v=14','./routing.js','./engelhard-logo.svg','./version.json','./manifest.webmanifest'];
