const CACHE='routenplaner-r5-5-0-20260727';
const ASSETS=['./','./index.html','./styles.css?v=15','./app.js?v=15','./core.js?v=15','./routing.js','./engelhard-logo.svg','./version.json','./manifest.webmanifest'];
