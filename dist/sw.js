const CACHE='routenplaner-r5-6-0-20260727';
const ASSETS=['./','./index.html','./styles.css?v=17','./app.js?v=17','./core.js?v=17','./routing.js','./engelhard-logo.svg','./version.json','./manifest.webmanifest'];
