const CACHE='routenplaner-r5-4-1-20260727';
const ASSETS=['./','./index.html','./styles.css?v=12','./app.js?v=12','./core.js?v=12','./routing.js','./engelhard-logo.svg','./version.json','./manifest.webmanifest'];
