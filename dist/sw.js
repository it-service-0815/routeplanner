const CACHE='routenplaner-r5-4-0-20260727';
const ASSETS=['./','./index.html','./styles.css?v=11','./app.js?v=11','./core.js?v=11','./routing.js','./engelhard-logo.svg','./version.json','./manifest.webmanifest'];
